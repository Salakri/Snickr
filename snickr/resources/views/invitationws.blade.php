...
<div class="container">
    <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
            <form role="form" method="POST" action="{{ action('InviteController@insertws',['wid'=>$wid,'num'=> 3]) }}"><!--TODO: change num-->
                {{csrf_field()}}

                <!-- invitation list ######################################################################-->
                <p>Invitation List</p>
                <div class="form-group">
                    <input class="form-control" id="workspacedes1" type="email" placeholder="Email 1" name="email1">
                </div>
                <div class="form-group">
                    <input class="form-control" id="workspacedes2" type="email" placeholder="Email 2" name="email2">
                </div>
                <div class="form-group">
                    <input class="form-control" id="workspacedes3" type="email" placeholder="Email 3" name="email3">
                </div>
                <!-- buttons ######################################################################-->
                <input class="btn btn-primary btn-block" type="submit" value="Invite">
                <p></p>
            </form>
            <a class="btn btn-secondary btn-block" href="{{ url('/invitews/back') }}">Cancel</a>
        </div>
    </div>
</div>
